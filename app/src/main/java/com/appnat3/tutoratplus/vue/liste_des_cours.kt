package com.appnat3.tutoratplus.vue
...
import com.appnat3.tutoratplus.présentateur.PrésentateurListeCours
import com.appnat3.tutoratplus.présentateur.PrésentateurMenu
...
class liste_des_cours : Fragment() {
    ...
    override fun onCreateView(
        ...
        btnRetour = vue.findViewById(R.id.btn_retour)
        btnRetour.setOnClickListener {
            présentateur.effectuerNavigationMenu()
        }

        btnSuivant = vue.findViewById(R.id.btn_suivant)
